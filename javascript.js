<!doctype html><html lang="en" dir="ltr"><head> 
 <style type="text/css" id="dcoder_stylesheet">@import url('https://fonts.googleapis.com/css2?family=Recursive:wght@400;500;600;700;800;900&display=swap');
...
View Compiled</style></head> 
 <body> 
  <div class="container"> 
    ...
    <div class="main"> 
     <header> 
      <div class="overlay"> 
       ...
       <p class="description">“All our dreams can come true, if we have the courage to pursue them.” </p> 
   ...
   <div class="links"> 
    <ul> 
     <li class="active"> <a href="#" style="--i: 0.05s">Home</a> </li> 
     <li> <a href="#" style="--i: 0.1s">About</a> </li> 
     <li> <a href="#" style="--i: 0.15s">Contact</a> </li> 
     <li> <a href="#" style="--i: 0.2s">Service</a> </li> 
     <li> <a href="#" style="--i: 0.25s">Portfolio</a> </li> 
    </ul> 
   </div> 
  </div> 
 
<script type="text/javascript" id="dcoder_script">const hamburger_menu = document.querySelector(".hamburger-menu");
